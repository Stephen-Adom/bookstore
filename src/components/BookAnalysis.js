    ...
    <div className="book-analysis flex items-center justify-between w-full lg:w-[50%] mt-3">
      <div className="flex flex-col items-center md:flex-row gap-x-4">
        ...
        <div className="mt-1 text-center lg:text-left lg:mt-0">
          <h1 className="text-3xl font-light lg:text-4xl">{book.completed}</h1>
      ...
      <div className="flex flex-col gap-y-2 w-[60%] text-center md:text-left">
        ...
        <button type="button" className="w-full lg:w-[45%] mt-1 lg:mt-4 font-light px-3 py-1 text-white border-2 bg-primaryBlue border-primaryBlue hover:bg-blue-700 hover:border-blue-700">UPDATE PROGRESS</button>
      </div>
    </div>
  );
};
